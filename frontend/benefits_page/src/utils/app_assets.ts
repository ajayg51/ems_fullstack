export class AppAssets{
    static logoRootPath = "assets/logos";
    static iconRootPath = "assets/icons";

    static searchIcon = `${this.iconRootPath}/icon_search.svg`;
    
    static gymLogo = `${this.logoRootPath}/gym.svg`;
